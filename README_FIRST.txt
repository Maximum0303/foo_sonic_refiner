Sonic Refiner v0.6.1 — Build and Package / ビルドと梱包
...
Package:
dist\foo_sonic_refiner_v0.6.1.fb2k-component
...
This source builds the Sonic Refiner v0.6.1 release package.
...
このソースからSonic Refiner v0.6.1正式版パッケージを作成できます。
